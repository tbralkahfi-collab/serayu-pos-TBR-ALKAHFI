...
-- Allow all approved users to SELECT (monitoring)
-- Keep INSERT/UPDATE/DELETE restricted to own data
-- =============================================
...
-- PURCHASES
DROP POLICY IF EXISTS "Users can CRUD own purchases" ON public.purchases;
...
-- CAPITAL
DROP POLICY IF EXISTS "Users can CRUD own capital" ON public.capital;
