          ...
          <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/20 shadow-lg">
            ...
            <CardContent className="space-y-6 p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="tanggalModal" className="text-sm font-medium">Tanggal Mulai Usaha</Label>
                  <Input
                    id="tanggalModal"
                    type="date"
                ...
                <div className="space-y-2">
                  <Label htmlFor="catatanModal" className="text-sm font-medium">Catatan</Label>
                  <Input
                    id="catatanModal"
              ...
              <div className="flex gap-3">
                <Button 
                  ...
                  className={`gap-3 px-6 py-3 text-base font-bold ${!modalAwalForm.tanggal ? 'opacity-50 cursor-not-allowed' : ''} bg-gradient-primary shadow-lg hover:shadow-xl transform hover:scale-105 transition-all`}
                  size="lg"
                >
                  {isSavingModalAwal ? (
